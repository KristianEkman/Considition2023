...
namespace Considition2023_Cs
{
    ...
    public class MapData
    {
        ...
        public required Dictionary<string, StoreLocation> locations { get; set; }
        public required List<Hotspot> Hotspots { get; set; }
    ...
    public class StoreLocation
    {
        ...
        internal int IndexKey { get; set; }
        internal List<StoreLocation> Neighbours { get; set; } = new List<StoreLocation>();
    }
    ...
    {
        public required ContainerData ClassicUnitData { get; set; }
        public required ContainerData RefillUnitData { get; set; }
        public required RefillMachineData Freestyle9100Data { get; set; }
        public required RefillMachineData Freestyle3100Data { get; set; }
        public required Dictionary<string, LocationType> LocationTypes { get; set; }
        ...
        public required List<string> CompetitionMapNames { get; set; }
        public required List<string> TrainingMapNames { get; set; }
    ...
    public class StoreLocationScoring
    {
        ...
        public int Freestyle9100Count { get; set; }
        public int Freestyle3100Count { get; set; }
